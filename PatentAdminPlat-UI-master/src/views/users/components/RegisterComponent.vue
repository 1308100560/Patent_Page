  ...
  <div class="container">
    ...
    <el-form ref="registerForm" :model="registerForm" :rules="rules" class="form">
      ...
      <div style="font-size: 14px;color:gray;margin: 20px 0 20px 0">
        已有账号？
        <Link style="color:#0093fa;cursor: pointer" to="/login">登录</Link>
      </div>
      ...
      <el-form-item class="form-item" label="角色" prop="password">
        <el-select v-model="registerForm.roleId" placeholder="请选择" style="width: 100%">
          <!--          <el-option-->
          <!--            :value="1"-->
          <!--            label="管理员"-->
          <!--          />-->
