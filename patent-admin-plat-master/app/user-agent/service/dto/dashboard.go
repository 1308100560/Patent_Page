...
type Dashboard struct {
	...
	// 认领专利发明人排行
	ClaimInventors []PatentProp `json:"claimInventors"`
	// 认领专利申请人排行
	ClaimApartments []PatentProp `json:"claimApartments"`
}

type PackageDashboard struct {
	// 专利数量
	...
	Collaborators []*Researcher `json:"collaborators"`
	// 专利包发明人排行
	PackageInventors []PatentProp `json:"packageInventors"`
	// 专利包申请人排行
	PackageApartments []PatentProp `json:"packageApartments"`
}
