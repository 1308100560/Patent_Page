...
func (e *Search) GetQueryPage(c *dto.StoredQueryPagesReq, list *[]models.StoredQuery, count *int64) error {
	var err error
...
func (e *Search) FindQueryPages(c *dto.StoredQueryPagesReq, list *[]models.StoredQuery, count *int64) error {
	var err error
	var data models.StoredQuery
	err = e.Orm.Model(&data).
		Scopes(cDto.Paginate(c.GetPageSize(), c.GetPageIndex())).
