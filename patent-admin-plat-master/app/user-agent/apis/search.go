...
func (e Search) AuthSearch(c *gin.Context) {
	...
	InternalTrace(c).SearchTracing(req.Query)
...
// @Router /api/v1/user-agent/auth-search/charts/{aid} [POST]
// @Security Bearer
func (e Search) GetChart(c *gin.Context) {
	...
	InternalTrace(c).GraphTracing(cp.Name)
